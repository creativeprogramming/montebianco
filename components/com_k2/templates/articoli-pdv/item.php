...
<div itemscope id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemVideoBlock">
  	<h3><?php echo JText::_('K2_MEDIA'); ?></h3>
		...
		<?php endif; ?>
                   <span style="float:right;" class="spegniLaLuce">
                <a href="javascript:turnOffTheLights();"><img style="position:relative; top:10px; left:10px;" src="/images/1342255984_lamp.png"/>Eye comfort </a>
                   </span>
                <span style="float:right; display:none;" class="accendiLaLuce">
                   <a href="javascript:turnOnTheLights();"><img  style="position:relative; top:10px; left:10px;" src="/images/1342256020_lightbulb.png"/>Riaccendi la luce </a>
               </span>
  ...
  <?php endif; ?>
	  ...
	  <!-- Item Image -->
	  <div style="float:left;" class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  	
                            <img  itemprop="photo" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth/3*2; ?>px; height:auto;" />
	  ...
	  <?php endif; ?>
        ...
        <div class="ads-wrapper-centering" style="width:100%;">
          <br/>
           <ul class="check">
             <li><span> Vai su <a href="http://www.guida-vino.com">guida-vino.com</a> e regalati una bottiglia del tuo vino preferito!<span></li>
           </ul>
	...
	<?php /* disabled: scrollshare does it better!!!*/ if($this->item->params->get('itemTwitterButton',1) || $this->item->params->get('itemFacebookButton',1) || $this->item->params->get('itemGooglePlusOneButton',1)): ?>
	<!-- Social sharing -->
	...
	<?php endif; /*disabled */?>
         ...
         <div class="ads-wrapper-centering" style="width:100%;">
              ...
              <div class="itemAds1" style="margin: 0 auto; left:0; right:0; width: 468px;">
            <?php 
            //ad rotation 1/7 ste
            $estratto=rand(0, 7);
            if ($estratto != 3){ ?>
             <!-- ad nera - estratto <?php echo $estratto; ?> -->
                <script type="text/javascript"><!--
google_ad_client = "ca-pub-1741276698607727";
/* banner-468x60 */
google_ad_slot = "3225773802";
google_ad_width = 468;
google_ad_height = 60;
//-->
</script>
...
<?php }else{ ?>
<script type="text/javascript"><!--
google_ad_client = "ca-pub-7341718794342853";
/* parliamodivino end of article */
google_ad_slot = "0044455360";
google_ad_width = 468;
google_ad_height = 60;
//-->
</script>
...
<?php }//end ad rotation ?>
  ...
  <div class="itemLinks">
	  ...
	  <!-- Item tags -->
          <style>
            ul.itemCreativeTags{
              display: inline; /* niente accapo dopo "Etichettato sotto" */
                display: block; /* niente accapo dopo "Etichettato sotto" */
            }
            ul.itemCreativeTags > li:first-child {
    background: none, url("/images/creative-tag.png") 0 0 no-repeat;
padding: 4px 0 0 25px;
display: inline;
list-style: none;
}
ul.itemCreativeTags > li {
    background: none, url("/images/creative-tag.png") 0 0 no-repeat;
padding: 4px 0 0 25px;
display: inline;
list-style: none;
  ...
  <div class="itemAuthorBlock">
    ...
    <script>
      var authorblock= jQuery(".itemAuthorBlock")[0]; 
       jQuery(".itemAuthorBlock").css({"max-height":(77+jQuery(".itemAuthorDetails").height())+"px"}); //init
   /*  authorblock.addEventListener( 'webkitTransitionEnd', 
              function( event ) {
                  console.debug(event);
                  if (event.propertyName=="height"){
                      jQuery(".itemAuthorBlock").animate({"max-height":(77+jQuery(".itemAuthorDetails").height())+"px"});
                  }
                  //jQuery(".itemAuthorBlock").css("overflow","auto");
              } , false );
                   authorblock.addEventListener( 'oTransitionEnd', 
              function( event ) {
                  console.debug(event);
                    if (event.propertyName=="height"){
                      jQuery(".itemAuthorBlock").animate({"max-height":(77+jQuery(".itemAuthorDetails").height())+"px"});
                  ...
                  //jQuery(".itemAuthorBlock").css("overflow","auto");
                   ...
                   authorblock.addEventListener( 'transitioned', 
              function( event ) {
                  console.debug(event);
                    if (event.propertyName=="height"){
                      jQuery(".itemAuthorBlock").animate({"max-height":(77+jQuery(".itemAuthorDetails").height())+"px"});
  ...
  <?php endif; ?>
<!--
<?php echo $this->item->params->get('itemAuthorLatest');?> lateston?
-->
...
transition: all 2s;
 ...
 .relatediconholder:hover {  /* animate height for long images es. tutorials */ 
   cursor:pointer;
...
/* translate3d( 0, 0, 0); added to trigger hardware accelleration to try to prevent bad antialiasing, see: http://stackoverflow.com/questions/6846953/wonky-text-anti-aliasing-when-rotating-with-webkit-transform-in-chrome */
-webkit-transform: scale(2.3) rotate(-23deg) translate(0px, 0px) translate3d( 0, 0, 0);
-moz-transform: scale(2.3) rotate(-23deg) translate(0px, 0px) translate3d( 0, 0, 0);
-ms-transform: scale(2.3) rotate(-23deg) translate(0px, 0px) translate3d( 0, 0, 0);
-o-transform: scale(2.3) rotate(-23deg) translate(0px, 0px) translate3d( 0, 0, 0);
transform: scale(2.3) rotate(-23deg) translate(0px, 0px) translate3d( 0, 0, 0);
  ...
  box-shadow: 
            ...
            12px 12px 5px rgba(90,70,50,.1);
                          ...
                          <a class="itemRelTitle" href="<?php echo $item->link ?>"><div class="relatediconholder">
                            <img style="width:35px;height:auto;" class="itemRelImg" src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" />
                          </div></a>	<?php endif; ?>
