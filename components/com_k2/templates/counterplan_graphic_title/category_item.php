...
//see: http://www.brucelawson.co.uk/2012/best-of-time/
        ...
        $hasVideo = !empty($this->item->video);
         $isVideoImgBg = false;
         if ($hasVideo ) {
            if ($this->item->params->get('catItemImage') && !empty($this->item->image) && $featuredBgEnabled==true) {
                $imgSrc = $this->item->image;
        ...
        <div <?php echo $extraStyle; ?> class="cbp_tmlabel">   
            ...
            if ($isFeaturedImgBg || $isVideoImgBg) {
                ?>
                <div class="featuredBackgroundOverlay<?php echo (($isVideoImgBg) ? "Video" : ""); ?> ">
                    <?php
                }
                ?>
                ...
                <div class="itembody">
                    ...
                    <?php if ($this->item->params->get('catItemIntroText')): ?>
                        ...
                        <div class="catItemIntroText">
                            <?php echo K2HelperUtilities::characterLimit(strip_tags($this->item->introtext, "<b><i>"),255,"..."); ?>
                        </div>
                    <?php endif; ?>
