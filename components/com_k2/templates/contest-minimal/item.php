...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlock" style="padding:0px; margin: 0px;">
		  <span class="itemImage" style="padding:0px; margin: 0px; float:left;">
		  	<a class="modal" rel="{handler: 'image'}"
                           onClick="alert('Clicca sul \'Mi Piace\' per votare questa illustrazione');" 
                               <?php
